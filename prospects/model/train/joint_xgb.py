...
inference yields a per-year trajectory vector (see prospects.model.joint).
...
Usage:
    python -m prospects.model.train.joint_xgb \
...
from prospects.model.joint import (  # noqa: E402
