...
can run via:
    python -m prospects.model.hazards.survival \\
        --out models/event_classifiers_v1.11.pkl

Usage:
    python -m prospects.data.backfills.post_repull_chain
"""
from __future__ import annotations

import sqlite3

from prospects.data.backfills.post_dedup_verify import verify
...
def main():
    ...
    print("  python -u -m prospects.model.hazards.survival "
          "--out models/event_classifiers_v1.11.pkl")
