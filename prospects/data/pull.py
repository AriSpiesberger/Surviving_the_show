...
def phase_diagnostics() -> None:
    ...
    try:
        from prospects.data.sources.pybaseball import quick_diagnostic as pyb_diag
        print("\n--- pybaseball ---")
    ...
    try:
        from prospects.data.sources.milb import quick_diagnostic as milb_diag
        print("\n--- MLB Stats API (MiLB) ---")
    ...
    try:
        from prospects.data.sources.ncaa import quick_diagnostic as ncaa_diag
        print("\n--- ncaa_bbStats ---")
...
def phase_outcomes(db: ProspectDB) -> None:
    ...
    from prospects.data.sources.outcomes import pull_outcomes
...
def phase_ncaa(db: ProspectDB) -> None:
    ...
    from prospects.data.sources.ncaa import pull_college_stats_for_player
