"""
prospects/data/sources/pybaseball.py
==========================================
...
Usage:
    from prospects.data.sources.pybaseball import (
        pull_mlb_outcomes,
        pull_draft_data,
        pull_allstar_awards,
    )
...
from prospects.core.schema import CareerOutcome
from prospects.core.labels import label_career
