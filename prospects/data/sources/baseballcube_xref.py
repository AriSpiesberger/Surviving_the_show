"""
prospects/data/sources/baseballcube_xref.py
==========================================
...
Usage
-----
    python -m prospects.data.sources.baseballcube_xref            # all ids in the rankings CSV
    python -m prospects.data.sources.baseballcube_xref --limit 50 # smoke test
...
from prospects.data.sources.baseballcube import (
    BASE, DEFAULT_CSV as RANKINGS_CSV, _get,
)

from prospects.config import REPO_ROOT
PLAYER_URL = f"{BASE}/content/player/{{pid}}/"
DEFAULT_XREF = REPO_ROOT / "data" / "baseballcube_player_xref.csv"
